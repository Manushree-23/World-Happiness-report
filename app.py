...
#Creating Callbacks(Flask routes)
...
def update_top_bottom(selected_metric):
    ...
    return html.Div([
        html.Div([html.H3("Top 5 Countries"), top_countries_list], className="top-bottom-section"),
        html.Div([html.H3("Bottom 5 Countries"), bottom_countries_list], className="top-bottom-section")], className='top-bottom-container')

#Click a country and display info
@app.callback(
    Output('country-details','children'),
    Input('world-map', 'clickData')
)

def dispaly_country_details(clickData):
    if clickData:
        ...
        if not country_data.empty:
            ...
            details=[
                ...
                html.P(f"Perceptions of Corruptions: {country['Perceptions of corruption']}")
            ]
